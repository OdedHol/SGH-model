...
class SGH_class:
    def __init__(self, a=0.05, c=0.2, k=1, d=0.01, p=1.5,
                       ...
                       tree_root_active=0, shading_active=1, logistic_active=1, 
    ...
    def analytical_solutions_no_carrying_capacity(self, **kwargs):
        ...
        B_star = (p['p'] - self.tree_root_function(None, S_star, **p) - self.drainage(None, S_star, **p)) / (p['e0'] * self.shading_transpiration(None, None, **p) * S_star)
    ...
    def equ(self, y, **kwargs):
        ...
        dsdt_numerator = (p['p'] - self.drainage(B, S, **kwargs) 
